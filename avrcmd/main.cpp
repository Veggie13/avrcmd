...
int main(int argc, char** argv)
{
    ...
    handle = usbOpenDevice(0x16C0, "veggie", 0x05DC, "Template");
    ...
    nBytes = usb_control_msg(handle, 
        ...
        USB_GET_BITS, 0, 0, (char *)buffer, sizeof(buffer), 5000);
    ...
    else
    {
        ...
        {
            char c1 = table[(buffer[i] >> 4) & 0xf];
            char c2 = table[buffer[i] & 0xf];
            printf("%c%c ", c1, c2);
        }
        printf("\n");
    }
